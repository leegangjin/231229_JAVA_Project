...
public class Method01 {
	...
	public static void main(String[] args) {
		/* Method(매서드) : 기능(함수) , function
		 * 매서드 선언 및 구현
		 * 접근제한자(제어자) 리턴타입 매서드명 (매개변수){
		 *       구현;
		 * }
		 * 
		 * -접근제한자(제어자) : 접급할 수 있는 주체의 제한범위
		 * -리턴타입 : 반환값의 타입 (매서드 실행 후 결과로 알려주는 값의 자료형)
		 * -매서드명 : 매서드의 이름(소문자로 시작)
		 * -매개변수 : 기능을 수행하기위해 필요로 하는 값(외부에서 들어와야 하는 값)
		 * -void : 리턴할 것이 없다는 것을 의미 
		 * 
		 * -매서드의 위치
		 * -클래스 안, 다른 매서드 밖
		 * -매서드의 선언 순서는 아무 상관 없음.
		 * -매서드는 순서대로 실행되지 않음.
		 * -호출이 되어야 매서드는 실행된다.
		 */
	...
	//리턴타입 : void => 없음.(출력)
	//매개변수 : 두정수 (int num1, nt num2)
	public static void sum1(int num1,int num2) {
		System.out.println(num1 + num2);
	}
	//두 정수가 주어지면 두정수의 차를 알려주는 (리턴하는 메서드)
	//리턴타입 : 차 ->int
	//매개변수 : 두 정수 (int num1 , int num2)
	      //num1 과 num2 중 큰수에서 작은수를 뺴서 결과를 리턴 
