...
public class 상속01 {
	...
	public static void main(String[] args) {
		 ...
		 * -접근제한자가 private 이면 자식 클래스에서 접근 불가능
		 * -접근제한자 protected :상복받는 자식에게 허용하는 제어자
		 * 
		 */
		A a =new A();
		a.setA(10);
		...
		b.setB(200);
		b.setC(300);
		b.num = 1000; //접근제한자가 prtected이기 때문에 직접 접근 가능
		b.print();
		b.setD(10);
		b.setE(20);
		b.setF(30);
...
class A{ //부모 클래스
private int a,b,c; //상속 불가능 나만 사용가능
